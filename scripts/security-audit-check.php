 ...
 *
 * Declared as a constant so {@see \Phlix\Anidb\Tests\Unit\SecurityAuditCheckTest} can assert the list directly
 ...
 *
 * Measured on this repository's committed lock 2026-08-06: 32 packages
 * (5 require + 27 require-dev). The floor sits below that so ordinary
 ...
 * on this repository's committed lock: 27 dev packages.
 */
const MIN_AUDITED_DEV_PACKAGES = 23;
